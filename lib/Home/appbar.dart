...
import 'package:HOPE/Home/article.dart';
import 'package:HOPE/Home/result.dart';
                  ...
                  children: [
                    ...
                    GestureDetector(
                      onTap: () {
                        showDialog(
                            context: context,
                            builder: (context) => const ResultPage(score: 85));
                      },
